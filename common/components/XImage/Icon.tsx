...
// TODO, integrate this class into XImages
// TODO, find a counterpart for web as well
export default class Icon extends Component {

  // todo, introduce enum for the font-families and load them on-the-fly
  componentDidMount() {
    const {iconFamily} = this.props;
    let _iconFamily = "MaterialCommunityIcons";
    if (!isNullEmpty(iconFamily)) {
      _iconFamily = iconFamily;
    }
    import(`react-native-vector-icons/${_iconFamily}`);
  }
